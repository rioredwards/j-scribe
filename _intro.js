[
  ...
  {
    content:
      "\n## Scope\n\nCode cells share a scope with any cells above them in your notebook. This enables you to write notes/documentation in-between cells (like this).",
    type: "text",
    id: "cdgex",
  },
  {
  ...
  {
    content:
      "## [React](https://react.dev/) comes built-in\nReact is a very popular javascript framework. We decided to build it into j-scribe for your convinience (no setup required).\n\nNote: Behind the scenes, your react-code is being compiled with every keystroke using [esbuild](http://esbuild.github.io/) and [Wasm](https://webassembly.org/).",
    type: "text",
    id: "46eyu",
  },
  {
